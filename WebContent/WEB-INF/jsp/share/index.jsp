...
<body class="index desktop" onselectstart="return false;">
	...
	<div id="wrap" style="width: 830px">
		...
		<form method="post" action="">
			<p align="center">
				<label> <input style="color: #707070;" onblur="setInputTip(this)" onclick="clearValue(this)" type="text"
					class="text" id="url" name="url" size="100" /> </label> <br /> <label> <input class="text"
					style="color: #707070;" type="text" id="add-keyword" name="keyword" size="15" readonly="readonly" /> </label>
			</p>
			<center>
				<input type="submit" id="add-button" onmouseout="this.className='button'" onmousedown="this.className='btn'"
					name="add-button" class="button" style="font-size: 16px" value="立即生成" />
			</center>
		</form>
	</div>
